...
def main():
    ...
    for data_path in data_path_all:
        ...
        active_quads =[bias_A, bias_B, bias_C, bias_D]   
            
        quads = ['Quad A','Quad B', 'Quad C', 'Quad D']
        
        # Now let's save the full_frame images
        plot_dir = file_path+'/Trailing_Overclocks'
        ...
        for k in np.arange(0, 4):
            ...
            median_plot = r'Outlier_median_tsoc'+'/'+ quads[k]
            ...
            if k == 0:
                title = 'Histogram of Trailing Overclocks of Quad A'
            elif k==1:
                title = 'Histogram of Trailing Overclocks of Quad B'
            elif k==2:
                title = 'Histogram of Trailing Overclocks of Quad C'
            else:
                title = 'Histogram of Trailing Overclocks of Quad C'
...
#            # Secondly, the same for median ased approach
            ...
            if k == 0:
                title = 'Binary Outlier Mask of Quad A trailing overclocks'
            elif k==1:
                title = 'Binary Outlier Mask of Quad B trailing overclocks'
            elif k == 2:
                title = 'Binary Outlier Mask of Quad C trailing overclocks'
            else:
                title = 'Binary Outlier Mask of Quad D trailing overclocks'    
