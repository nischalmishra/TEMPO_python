...
def main():
    ...
    file_path1 = r'F:\TEMPO\Data\GroundTest\FPS\Spectrometer\Photon_Transfer_TVAC\saved_quads'
    ...
    for i in range(0, 4):
        ...
        for data_files in nominal_int_files:
            ...
            #active_quad_even = active_quad_even[:,:-1]
...
#            cc
            ...
            plt.plot(active_quad_even, tsoc_even_all,'b.')
            plt.show()
            cc
