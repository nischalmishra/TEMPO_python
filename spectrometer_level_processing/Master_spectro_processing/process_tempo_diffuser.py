...
import h5py
from process_tempo_level0 import read_idl_file,\
                                 read_h5_file,\
...
def main():
    ...
    image_save_dir = os.path.join(data_dir, r'processed_h5\Updated_Linearity')
