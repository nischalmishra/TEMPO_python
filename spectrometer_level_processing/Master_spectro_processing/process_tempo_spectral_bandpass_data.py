...
def main():
    ...
    data_dir = r'F:\TEMPO\Data\GroundTest\FPS\Spectrometer\Bandpass_Analysis\Visible\727.5_nm'
    telemetry_dir = r'F:\TEMPO\Data\GroundTest\FPS\Spectrometer\2017.08.14'
   ...
   # image_save_dir = os.path.join(data_dir, r'saved_quads\processed_h5\Dark_Data')
    image_save_dir = r'F:\TEMPO\Data\GroundTest\FPS\Spectrometer\Spectral_Band_Pass_Data\297.8_nm\processed_h5'
   ...
   # print('Total data = ', len(data_path_all)) # sanity check
    ...
    for data_path in data_path_all[432:]:
