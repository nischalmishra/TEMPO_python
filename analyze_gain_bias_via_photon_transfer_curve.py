...
def main():
    ...
    file_path = r'C:\Users\nmishra\Workspace\TEMPO\Data\GroundTest\FPA_Gain_Vs_Temp'
    temp_folder = os.listdir(file_path)

    data_folder = r'Script_Data\saved_quads'
    for files in  range(1, len(temp_folder)):        
        all_int_time = [ ]
        all_med_quad_A = [ ]
        all_med_quad_B = [ ]
        all_med_quad_C = [ ]
        ...
        plot_dir = os.path.join(file_path, temp_folder[files], data_folder, save_dir)
        ...
        for data_files in nominal_int_files:           
            ...
            #Because you really want the entire histogram to remain
            #after the subtraction, you add an offset to one frame before differencing. Usually
            #1000 DN is adequate
            
            diff_two_frames =  1000 + (bias_subtracted_quad_A[1,800:1800, 800:1800]) - bias_subtracted_quad_A[0,800:1800, 800:1800]
            ...
            diff_two_frames =  (1000+ bias_subtracted_quad_B[1,800:1800, 800:1800])- bias_subtracted_quad_B[0,800:1800, 800:1800]
            ...
            diff_two_frames =  (1000+bias_subtracted_quad_C[1,800:1800, 800:1800])- bias_subtracted_quad_C[0,800:1800, 800:1800]
            #diff_two_frames = filter_outlier_median(diff_two_frames)
            sigma_s = np.std(diff_two_frames)/2
            ...
            diff_two_frames =  (1000+bias_subtracted_quad_D[1,800:1800, 800:1800])- bias_subtracted_quad_D[0,800:1800, 800:1800]
            #diff_two_frames = filter_outlier_median(diff_two_frames)
            sigma_s = np.std(diff_two_frames)/2
...
#            plt.close('all')
        ...
        dframe1.to_csv(plot_dir+'/'+'DN_vs_Noise_sub_pixel'+str(temp)+'.csv')
